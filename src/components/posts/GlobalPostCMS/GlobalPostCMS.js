...
const GlobalPostCMS = (props) => {
  const { item, isVisible, typePost } = props;
  ...
  return (
    <View style={styles.container}>
      ...
      <FooterGlobalPost item={item} typePost={typePost} />
    </View>
  );
};
...
GlobalPostCMS.defaultProps = {
  applyPremium: false
}
export default GlobalPostCMS;
